...
class TestViews(TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.valid_keys = ['country_code', 'country_name', 'region_name', 'city_name', 'latitude', 'longitude', 'zip_code', 'time_zone']
    ...
    def test_all_invalid_ip_address(self):
        ...
        res_v6 = self.client.get(reverse('all', args=['zzzz:0000:0000:0000:0000:ffff:0100:5000']))

        self.assertEqual(res_v4.status_code, 404)
        self.assertEqual(res_v6.status_code, 404)

        self.assertIsNotNone(res_v4.json().get('error'))
        self.assertIsNotNone(res_v6.json().get('error'))
    ...
    def test_unique_invalid_ip_address(self):
        ...
        res_v6 = self.client.get(reverse('unique', args=['zzzz:0000:0000:0000:0000:ffff:0100:5000', 'country_name']))
    ...
    def test_unique_invalid_key_argument(self):
        ...
        self.assertEqual(res_v4.status_code, 404)
        self.assertEqual(res_v6.status_code, 404)
        self.assertEqual(res_v4.json().get('error'), 'invalid key')
        self.assertEqual(res_v4.json().get('error'), 'invalid key')
    ...
    def test_unique_response_ip_address_decimal(self):
        res_v4 = self.client.get(reverse('unique', args=[self.test_ipv4, 'ip_address_decimal']))
        res_v6 = self.client.get(reverse('unique', args=[self.test_ipv6, 'ip_address_decimal']))
    ...
    def test_unique_response_country_code(self):
        res_v4 = self.client.get(reverse('unique', args=[self.test_ipv4, 'country_code']))
        res_v6 = self.client.get(reverse('unique', args=[self.test_ipv6, 'country_code']))
    ...
    def test_unique_response_country_name(self):
        res_v4 = self.client.get(reverse('unique', args=[self.test_ipv4, 'country_name']))
        res_v6 = self.client.get(reverse('unique', args=[self.test_ipv6, 'country_name']))
    ...
    def test_unique_response_region_name(self):
        res_v4 = self.client.get(reverse('unique', args=[self.test_ipv4, 'region_name']))
        res_v6 = self.client.get(reverse('unique', args=[self.test_ipv6, 'region_name']))
    ...
    def test_unique_response_longitude(self):
        ...
        self.assertEqual(res_v4.json(), float(self.ipv4_test_data.__dict__['longitude']))
        self.assertEqual(res_v6.json(), float(self.ipv6_test_data.__dict__['longitude']))
